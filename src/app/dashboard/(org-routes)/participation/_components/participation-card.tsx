...
const ParticipationCard = async () => {
  ...
  const handleParticipation = async () => {
    ...
    try {
      // Call the createParticipation function with the organizationId
      const newParticipant = await createParticipation(id!)

      // Handle successful participation
      if (newParticipant) {
        toast({
          title: "Participation Successful",
          description: `You have successfully participated for organization ${id}.`,
          action: (
            <ToastAction altText="Go back to Participation Page">
              Back
            </ToastAction>
          ),
        })
